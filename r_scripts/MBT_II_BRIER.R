...
p <- ggplot(df_long, aes(x = Batch, y = Accuracy, color = Type, group = Type)) +
  geom_line() +
  geom_point() +
  labs(title = "Training and Validation Accuracies for the Brier Objective Function",
       x = "Batches",
       y = "Accuracy") +
...
ggsave(filename = "C:/Users/Mads/OneDrive/SDU/Thesis/bnn/tex/Thesis/Figures/MBT_II_BRIER.png", plot = p, dpi = 300, bg = "white")
