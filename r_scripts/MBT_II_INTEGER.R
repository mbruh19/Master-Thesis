...
for (file in files) {
  ...
  if (temp$settings$algorithm == 'batch_training' && temp$settings$objective_type == objective_function &&
      ...
      temp$settings$bernoulli_parameter==1) {
...
#ggsave(filename = "C:/Users/Mads/OneDrive/SDU/Thesis/bnn/tex/Thesis/Figures/MBT_II_INTEGER.png", plot = p, dpi = 300, bg = "white")
