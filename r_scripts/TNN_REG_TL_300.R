...
setwd("C:/Users/Mads/OneDrive/SDU/Thesis/bnn/log/TNN_REG_TL_300")
files <- list.files()
...
caption = "Summary statistics for single batch training of a TNN with 1000 samples. 
          ...
          300 seconds. "
xt <- xtable(summary_stats, align = align_string, caption = caption, label = "TNN_REG_TL_300")
...
output_file <- "C:/Users/Mads/OneDrive/SDU/Thesis/bnn/tex/Thesis/Tables/TNN_REG_TL_300.tex"
