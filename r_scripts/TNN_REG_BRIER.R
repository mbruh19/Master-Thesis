...
setwd("C:/Users/Mads/OneDrive/SDU/Thesis/bnn/log/TNN_REG_BRIER")
files <- list.files()
...
caption = "Summary statistics for single batch training of a TNN with 2000 samples. 
          ...
          300 seconds."
xt <- xtable(summary_stats, align = align_string, caption = caption, label = "TNN_REG_BRIER")
...
output_file <- "C:/Users/Mads/OneDrive/SDU/Thesis/bnn/tex/Thesis/Tables/TNN_REG_BRIER.tex"
