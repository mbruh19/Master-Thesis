...
setwd("C:/Users/Mads/OneDrive/SDU/Thesis/bnn/log/MBT_FTBP_CS_small")
files <- list.files()
...
# Convert to xtable
final_xtable <- xtable(final_table, align = align_string, caption = caption, label = "MBT_FTBP_CS_small", digits = c(0,0,1,4,4))

# Specify the file path
output_file <- "C:/Users/Mads/OneDrive/SDU/Thesis/bnn/tex/Thesis/Tables/MBT_FTBP_CS_small.tex"
...
write(latex_code, file = "C:/Users/Mads/OneDrive/SDU/Thesis/bnn/tex/Thesis/Tables/MBT_FTBP_CS_small.tex")
