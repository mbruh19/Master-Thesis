...
p <- ggplot(summary_stats, aes(x = TimeLimit, y = Mean, 
  ...
  labs(title = "Comparison of BNN vs TNN with the Brier Objective Function",
...
ggsave(filename = "C:/Users/Mads/OneDrive/SDU/Thesis/bnn/tex/Thesis/Figures/BNN_vs_TNN_brier.png", plot = p, dpi = 300, bg = "white")
