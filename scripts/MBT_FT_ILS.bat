...
for /L %%s in (1, 1, 4) do (
    for /L %%o in (0, 1, 3) do (
        for /L %%n in (0, 1, 1) do (
            ...
            echo !lf!
            python -m main -ct !ct! -nt !nt! -ns !nss[%%n]! -ds !ds! -vp !vp! -bs !batchsize! -ts !ts! -st !st! -ot !objective! -al !al! -se !seeds[%%s]! -tl !tl! -bp !bps[%%o]! -l !l! -lf !lf! -es !es! -ni !ni! -ps !ps! -smtl !smtl! -ep !ep!
            echo !lf!   
        )
    )
)
